...
public class Pause extends Button{
    private final String BUTTON_RELEASED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/ANBArhp.png')";
    private final String BUTTON_PRESSED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/ANBArhp.png')";
