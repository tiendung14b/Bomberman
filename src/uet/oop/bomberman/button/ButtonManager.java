package uet.oop.bomberman.button;//for large button and should be use for menu
...
public class ButtonManager extends Button{
    private final String BUTTON_RELEASED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/QzoxzCm.png')";
    private final String BUTTON_PRESSED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/abqn0ZC.png')";
