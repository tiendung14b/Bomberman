...
public class Resume extends Button{
    private final String BUTTON_RELEASED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/k3OUIa5.png')";
    private final String BUTTON_PRESSED_STYLE = "-fx-background-color: transparent; -fx-background-image: url('https://i.imgur.com/k3OUIa5.png')";
